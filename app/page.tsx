...
import HeroVerticalSlider from '@/components/HeroVerticalSlider';
...
const featuredNeedSlugs = ['cholera-response-drc', 'solar-power-maternity', 'kapsowar-ultrasound'];
    ...
    <>
      <section className='relative overflow-hidden border-b border-hair'>
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(#1F1B14 1px, transparent 1px)',
        ...
        <div className='relative z-10 pb-10 '>
          <Header />
          <div className='grid md:grid-cols-2 md:pl-20'>
            <div className='py-20 relative flex justify-center items-center md:py-[104px]  '>
              <div className='relative'>
                <Reveal>
                  <div className='mb-4 flex items-center justify-start gap-3'>
                    {/* <span aria-hidden className="h-px w-12 bg-terra/60" /> */}
                    <Eyebrow className='m-0 max-w-measure normal-case tracking-[0.12em]'>
                ...
                <Reveal delay={80}>
                  <h1 className=' max-w-[14ch] text-balance font-serif text-[clamp(2.75rem,7.5vw,6.75rem)] font-light leading-[1.03] tracking-[-0.035em] text-ink md:leading-[1.02]'>
                ...
                <Reveal delay={160}>
                  <p className='prose-measure mt-8  font-normal leading-[1.7] tracking-[0.01em] text-ink-2 md:mt-10 md:leading-[1.72]'>
                    A catalog of Christian medical mission hospitals worldwide. For those called to serve, those moved
                    to give.
                  </p>
                </Reveal>
                <Reveal delay={240}>
                  <div className='mt-11 flex flex-wrap justify-start gap-3'>
            ...
            <div className='relative min-h-[320px] h-[90%]  w-full self-center overflow-hidden rounded-l-full bg-terra/80 sm:min-h-[420px] md:min-h-[480px]'>
              <HeroVerticalSlider />
            </div>
          </div>
              ...
              {heroStats.map((stat, i) => (
                <Reveal
                  ...
                  className={[
                    ...
                    i < heroStats.length - 1 ? 'sm:border-r sm:border-hair' : '',
                    i === 0 ? 'sm:pl-0' : '',
      ...
      <section id='hospitals' className='border-b border-hair bg-bone py-20 md:py-24'>
      ...
      <section id='needs' className='border-t border-hair bg-paper py-20 md:py-24'>
        <div className='container-page'>
          <div className='flex flex-wrap items-end justify-between gap-8 border-b border-hair/80 pb-10'>
            <Reveal>
              <p className='mb-3 font-sans font-extrabold text-[12.5px] uppercase tracking-[0.1em] text-ink-2 md:text-sm'>
              ...
              <h2 className='max-w-[17ch] text-balance font-serif text-[clamp(2rem,4.8vw,3.75rem)] font-light leading-[1.08] tracking-tight text-ink md:leading-[1.05]'>
                Active <em className='italic text-terra'>missionary needs</em>.
              </h2>
            </Reveal>
            <Reveal delay={120}>
          ...
          <div className='grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.35fr)] lg:gap-16'>
            ...
            <Reveal delay={120}>
              ...
              <blockquote className='prose-measure font-serif text-[clamp(1.5rem,3.2vw,2.5rem)] font-light  leading-[1.28] tracking-[-0.01em] text-ink md:leading-[1.32]'>
                &ldquo; The cath lab paid for itself in <em className='not-italic text-terra'>two weeks</em>. Three
                patients who would have died on the way to Nairobi are alive in our follow-up clinic. &rdquo;
              </blockquote>
              <cite className='mt-9 block font-sans text-[12.5px] font-semibold uppercase leading-relaxed tracking-[0.09em] text-ink not-italic md:text-sm'>
                <strong className='font-semibold text-ink'>Dr. James Otieno</strong>
                <br className='sm:hidden' />
                <span className='hidden sm:inline'> · </span>
                <span className='text-ink-2'>Tenwek Hospital, Kenya</span>
              </cite>
              <Link href='/news' className='link-chapter group mt-10 inline-flex items-center gap-2'>
                More field reports
                <span className='transition-transform duration-200 group-hover:translate-x-1'>→</span>
              </Link>
            </Reveal>
