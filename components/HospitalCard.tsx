...
export default function HospitalCard({ hospital }: HospitalCardProps) {
  return (
    ...
    >
      ...
      <p
        className="mb-[18px] text-[16.5px] leading-[1.55] text-ink-2"
        dangerouslySetInnerHTML={{ __html: hospital.blurb }}
      />
      <div className="flex gap-6 border-t border-hair-soft pt-[14px] text-[15px] text-ink-2">
        <div>
